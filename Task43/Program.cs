...
if (IsNotEqualLines(k1, k2, b1, b2))
{
    ...
    else Console.WriteLine("Вы ввели параллельные линии, но они никогда не пересекутся");
}
else Console.WriteLine("Вы ввели одинаковые линии и они наложенны друг на друга");